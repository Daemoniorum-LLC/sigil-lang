...
export class SigilRuntime {
  ...
  _consoleImports() {
    return {
      ...
      // println variants - the compiler maps println() calls to these
      println_i64: (val) => console.log(Number(val)),
      println_f64: (val) => console.log(val),
      println_str: (ptr, len) => console.log(this.readString(ptr)),
    };
  }
