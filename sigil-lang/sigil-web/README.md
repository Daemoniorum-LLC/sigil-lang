...
Sigil Web leverages Sigil's unique features to create a powerful, type-safe web framework:
...
Components are the building blocks of Sigil Web applications:
...
git clone https://github.com/daemoniorum/sigil-web
cd sigil-web && sigil build
```
...
- [Counter](examples/basic/counter.sigil) - Simple state management
- [Todo App](examples/basic/todo.sigil) - CRUD operations
