            ...
            match val {
                Value::Struct { name, fields } => {
                    ...
                    match field_val {
                        ...
                        None => {
                            crate::sigil_warn!(
                                "WARN: Unknown field '{}' on '{}' - returning null",
                                field_name,
                                name
                            );
                            Ok(Value::Null)
        ...
        match (&recv, method.name.as_str()) {
            ...
            (Value::Ref(r), _) => {
                ...
                if let Value::Struct { name, fields } = &inner {
                    ...
                    crate::sigil_warn!(
                        "WARN: Unknown method '{}' on '&{}' - returning null",
                        method.name,
                        name
                    );
                    return Ok(Value::Null);
            ...
            (
                ...
                crate::sigil_warn!(
                    "WARN: Unknown method '{}' on enum '{}' - returning null",
                    method.name,
                    enum_name
                );
                Ok(Value::Null)
            ...
            _ => {
                ...
                crate::sigil_warn!(
                    "WARN: Unknown method '{}' on recv_type={} - returning null",
                    method.name,
                    recv_type
                );
